...
all_df = pd.read_csv("https://raw.githubusercontent.com/nurfajaryulianto/Dicoding_Sub/main/data-analyst-dicoding-main/dashboard/df.csv?token=GHSAT0AAAAAACL77XAUP73IKMUT23B5YHM6ZMJCISA")
all_df.sort_values(by="order_approved_at", inplace=True)
all_df.reset_index(inplace=True)

# Geolocation Dataset
geolocation = pd.read_csv('https://raw.githubusercontent.com/nurfajaryulianto/Dicoding_Sub/main/data-analyst-dicoding-main/dashboard/geolocation.csv?token=GHSAT0AAAAAACL77XAUYONXXE3K66YPY6PEZMJCKMA')
...
with st.sidebar:
    ...
    with col1:
        st.write(' ')
    with col2:
        st.image("https://github.com/nurfajaryulianto/Dicoding_Sub/blob/2a81dab0cb2265dba8f2a0468ea2c866cb443c5a/data-analyst-dicoding-main/dashboard/logo.png"
                 , width=100)
    with col3:
        st.write(' ')
...
st.caption('Copyright (C) Nur Fajar Yulianto 2023')
