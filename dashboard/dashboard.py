...
all_df = pd.read_csv("https://raw.githubusercontent.com/nurfajaryulianto/Dicoding_Sub/main/dashboard/df.csv")
all_df.sort_values(by="order_approved_at", inplace=True)
all_df.reset_index(inplace=True)

# Geolocation Dataset
geolocation = pd.read_csv('https://raw.githubusercontent.com/nurfajaryulianto/Dicoding_Sub/main/dashboard/geolocation.csv')
...
with st.sidebar:
    ...
    with col1:
        st.write(' ')
    with col2:
        st.image("https://github.com/nurfajaryulianto/Dicoding_Sub/blob/67a33cd12997c8d5e71022d560f3185ed22fb113/dashboard/logo.png"
                 , width=100)
    with col3:
        st.write(' ')
